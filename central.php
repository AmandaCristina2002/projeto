...
$consultaDen = $MySQLi->query("SELECT * FROM TB_DENUNCIAS");
							...
							<div class="card">
								<div class="card-header">
										...
										<?php while ($resultado = $consulta->fetch_assoc()){?>
											<?php if($resultado['DEN_POL_CODIGO'] < '0'){?>
											<div class="col-12 col-md-5 col-lg-5 border border-dark" style="float:left;margin-top: 10px;margin-bottom: 10px;margin-right: 25px;margin-left: 25px;">
												<div class="card">
													<div class="card-body">
														...
														<BR>
														<a href="editar.php?codigo=<?PHP echo $resultado['DEN_CODIGO']; ?>" class="btn btn-lg" style="float:right;background:firebrick;color:white;">
														 Encaminhar denúncia</a>
													</div>
												</div>
											</div>
										<?php }
